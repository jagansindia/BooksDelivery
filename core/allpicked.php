...
$query=mysqli_query($conn,"UPDATE seller_picklist set picked='1',picked_time='$pickedtime',pickedby='$username' where order_product_id='$order_product_id'");//update picked in pick list table
